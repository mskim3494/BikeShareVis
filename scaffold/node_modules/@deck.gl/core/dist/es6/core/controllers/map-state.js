...
export default class MapState extends ViewState {
  ...
  pan({
    ...
    const _calculateNewLngLat = this._calculateNewLngLat({
      startPanLngLat,
      pos
    }),
          _calculateNewLngLat2 = _slicedToArray(_calculateNewLngLat, 2),
          longitude = _calculateNewLngLat2[0],
          latitude = _calculateNewLngLat2[1];
  ...
  rotate({
    ...
    const _interactiveState = this._interactiveState,
    ...
    const _calculateNewPitchAnd = this._calculateNewPitchAndBearing({
      deltaScaleX,
      deltaScaleY,
      startBearing,
      startPitch
  ...
  zoom({
    ...
    let _interactiveState2 = this._interactiveState,
  ...
  _zoomFromCenter(scale) {
    const _viewportProps = this._viewportProps,
  ...
  _panFromCenter(offset) {
    const _viewportProps2 = this._viewportProps,
  ...
  _calculateNewZoom({
    ...
    const _viewportProps3 = this._viewportProps,
  ...
  _calculateNewPitchAndBearing({
    ...
    const _viewportProps4 = this._viewportProps,
