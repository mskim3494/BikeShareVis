...
function () {
  ...
  _createClass(AttributeTransitionManager, [{
    ...
    value: function _createModel() {
      ...
      this.transform = new Transform(this.gl, Object.assign({}, (0, _attributeTransitionUtils.getBuffers)(this.attributeTransitions), (0, _attributeTransitionUtils.getShaders)(this.attributeTransitions)));
    ...
    value: function _triggerTransition(transition, settings) {
      ...
      var toState = new _luma.Buffer(this.gl, {
        size: size,
        data: value
      });
      ...
      transition.fromState = new _luma.Buffer(this.gl, Object.assign({}, fromState, {
