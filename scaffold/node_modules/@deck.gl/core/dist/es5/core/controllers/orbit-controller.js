...
var _orbitState = _interopRequireDefault(require("../controllers/orbit-state"));

var _viewportControls = _interopRequireDefault(require("../controllers/viewport-controls"));
...
function () {
  _createClass(OrbitController, null, [{
    ...
    value: function getViewport(viewport) {
      return new _orbitViewport.default(viewport);
    }
  }]);
  ...
  function OrbitController(props) {
    ...
    this._controls = props.orbitControls || new _viewportControls.default(_orbitState.default);
