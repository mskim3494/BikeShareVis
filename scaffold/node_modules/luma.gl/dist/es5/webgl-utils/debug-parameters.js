...
var BUFFER_PARAMETERS = (_BUFFER_PARAMETERS = {}, _defineProperty(_BUFFER_PARAMETERS, _constants.default.BUFFER_SIZE, {
  webgl1: 0
}), _defineProperty(_BUFFER_PARAMETERS, _constants.default.BUFFER_USAGE, {
  webgl1: 0 // GLenum indicating the usage pattern of the buffer.

}), _BUFFER_PARAMETERS);
exports.BUFFER_PARAMETERS = BUFFER_PARAMETERS;
var FENCE_SYNC_PARAMETERS = [_constants.default.OBJECT_TYPE, // GLenum, type of sync object (always GL.SYNC_FENCE).
_constants.default.SYNC_STATUS, // GLenum, status of sync object (GL.SIGNALED/GL.UNSIGNALED)
_constants.default.SYNC_CONDITION, // GLenum. object condition (always GL.SYNC_GPU_COMMANDS_COMPLETE).
_constants.default.SYNC_FLAGS // GLenum, flags sync object was created with (always 0)
];
exports.FENCE_SYNC_PARAMETERS = FENCE_SYNC_PARAMETERS;
var FRAMEBUFFER_ATTACHMENT_PARAMETERS = [_constants.default.FRAMEBUFFER_ATTACHMENT_OBJECT_NAME, // WebGLRenderbuffer or WebGLTexture
_constants.default.FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE, // GL.RENDERBUFFER, GL.TEXTURE, GL.NONE
_constants.default.FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE, // GL.TEXTURE_CUBE_MAP_POSITIVE_X, etc.
_constants.default.FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL, // GLint
// EXT_sRGB or WebGL2
_constants.default.FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING, // GL.LINEAR, GL.SRBG
// WebGL2
_constants.default.FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER, // GLint
_constants.default.FRAMEBUFFER_ATTACHMENT_RED_SIZE, // GLint
_constants.default.FRAMEBUFFER_ATTACHMENT_GREEN_SIZE, // GLint
_constants.default.FRAMEBUFFER_ATTACHMENT_BLUE_SIZE, // GLint
_constants.default.FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE, // GLint
_constants.default.FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE, // GLint
_constants.default.FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE, // GLint
_constants.default.FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE // GL.FLOAT, GL.INT, GL.UNSIGNED_INT, GL.SIGNED_NORMALIZED, OR GL.UNSIGNED_NORMALIZED.
];
exports.FRAMEBUFFER_ATTACHMENT_PARAMETERS = FRAMEBUFFER_ATTACHMENT_PARAMETERS;
var FRAMEBUFFER_STATUS = (_FRAMEBUFFER_STATUS = {}, _defineProperty(_FRAMEBUFFER_STATUS, _constants.default.FRAMEBUFFER_COMPLETE, 'Success. Framebuffer is correctly set up'), _defineProperty(_FRAMEBUFFER_STATUS, _constants.default.FRAMEBUFFER_INCOMPLETE_ATTACHMENT, 'Framebuffer attachment types mismatched or some attachment point not attachment complete'), _defineProperty(_FRAMEBUFFER_STATUS, _constants.default.FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT, 'Framebuffer has no attachment'), _defineProperty(_FRAMEBUFFER_STATUS, _constants.default.FRAMEBUFFER_INCOMPLETE_DIMENSIONS, 'Framebuffer attachments do not have the same size'), _defineProperty(_FRAMEBUFFER_STATUS, _constants.default.FRAMEBUFFER_UNSUPPORTED, 'Framebuffer attachment format not supported or depth and stencil attachments are not same'), _defineProperty(_FRAMEBUFFER_STATUS, _constants.default.FRAMEBUFFER_INCOMPLETE_MULTISAMPLE, 'Framebuffer attachement SAMPLES differs among renderbuffers, or are mixed with textures'), _FRAMEBUFFER_STATUS);
exports.FRAMEBUFFER_STATUS = FRAMEBUFFER_STATUS;
var PROGRAM_PARAMETERS = (_PROGRAM_PARAMETERS = {}, _defineProperty(_PROGRAM_PARAMETERS, _constants.default.DELETE_STATUS, {
  webgl1: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.LINK_STATUS, {
  webgl1: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.VALIDATE_STATUS, {
  webgl1: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.ATTACHED_SHADERS, {
  webgl1: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.ACTIVE_ATTRIBUTES, {
  webgl1: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.ACTIVE_UNIFORMS, {
  webgl1: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.TRANSFORM_FEEDBACK_BUFFER_MODE, {
  webgl2: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.TRANSFORM_FEEDBACK_VARYINGS, {
  webgl2: 0
}), _defineProperty(_PROGRAM_PARAMETERS, _constants.default.ACTIVE_UNIFORM_BLOCKS, {
  webgl2: 0 // GLint

}), _PROGRAM_PARAMETERS); //  parameters

exports.PROGRAM_PARAMETERS = PROGRAM_PARAMETERS;
var RENDERBUFFER_PARAMETERS = (_RENDERBUFFER_PARAMET = {}, _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_WIDTH, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_HEIGHT, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_INTERNAL_FORMAT, {
  type: 'GLenum',
  webgl1: _constants.default.RGBA4
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_GREEN_SIZE, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_BLUE_SIZE, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_RED_SIZE, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_ALPHA_SIZE, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_DEPTH_SIZE, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_STENCIL_SIZE, {
  webgl1: 0
}), _defineProperty(_RENDERBUFFER_PARAMET, _constants.default.RENDERBUFFER_SAMPLES, {
  webgl2: 1
}), _RENDERBUFFER_PARAMET);
exports.RENDERBUFFER_PARAMETERS = RENDERBUFFER_PARAMETERS;
var SAMPLER_PARAMETERS = (_SAMPLER_PARAMETERS = {}, _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_MAG_FILTER, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_MIN_FILTER, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_WRAP_S, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_WRAP_T, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_WRAP_R, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_BASE_LEVEL, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_MAX_LEVEL, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_COMPARE_FUNC, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_COMPARE_MODE, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_MIN_LOD, {
  webgl2: true
}), _defineProperty(_SAMPLER_PARAMETERS, _constants.default.TEXTURE_MAX_LOD, {
...
var TEXTURE_PARAMETERS = (_TEXTURE_PARAMETERS = {}, _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_MAG_FILTER, {
  type: 'GLenum',
  webgl1: _constants.default.LINEAR
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_MIN_FILTER, {
  type: 'GLenum',
  webgl1: _constants.default.NEAREST_MIPMAP_LINEAR
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_WRAP_S, {
  type: 'GLenum',
  webgl1: _constants.default.REPEAT
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_WRAP_T, {
  type: 'GLenum',
  webgl1: _constants.default.REPEAT
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_WRAP_R, {
  type: 'GLenum',
  webgl2: _constants.default.REPEAT
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_BASE_LEVEL, {
  webgl2: 0
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_MAX_LEVEL, {
  webgl2: 1000
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_COMPARE_FUNC, {
  type: 'GLenum',
  webgl2: _constants.default.LEQUAL
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_COMPARE_MODE, {
  type: 'GLenum',
  webgl2: _constants.default.NONE
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_MIN_LOD, {
  webgl2: -1000
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_MAX_LOD, {
  webgl2: 1000
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_WIDTH, {
  webgl1: 0
}), _defineProperty(_TEXTURE_PARAMETERS, _constants.default.TEXTURE_HEIGHT, {
  webgl1: 0
