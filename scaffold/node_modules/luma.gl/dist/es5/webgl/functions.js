...
function readPixels(gl, _ref) {
  var x = _ref.x,
      ...
      _ref$type = _ref.type,
      type = _ref$type === void 0 ? _api.default.UNSIGNED_BYTE : _ref$type,
      sourceHeight = _ref.sourceHeight,
      _ref$format = _ref.format,
      format = _ref$format === void 0 ? _api.default.RGBA : _ref$format;
...
function readPixelsToBuffer(gl, _ref2) {
  var x = _ref2.x,
      ...
      type = _ref2$type === void 0 ? _api.default.UNSIGNED_BYTE : _ref2$type,
      sourceHeight = _ref2.sourceHeight,
      _ref2$format = _ref2.format,
      format = _ref2$format === void 0 ? _api.default.RGBA : _ref2$format;
  (0, _context.assertWebGL2Context)(gl); // If source height is specified, a top left coordinate system is used

  y = sourceHeight ? sourceHeight - y : y;
  gl.bindBuffer(_api.default.PIXEL_PACK_BUFFER, buffer.handle);
  gl.readPixels(x, y, width, height, format, type, dataOffset);
  gl.bindBuffer(_api.default.PIXEL_PACK_BUFFER, null);
  return buffer;
}
/*
* @param {} opt.filter
...
function blitFramebuffer(gl, _ref3) {
  var _ref3$source = _slicedToArray(_ref3.source, 4),
      ...
      mask = _ref3$mask === void 0 ? _api.default.COLOR_BUFFER_BIT | _api.default.DEPTH_BUFFER_BIT | _api.default.STENCIL_BUFFER_BIT : _ref3$mask,
      _ref3$filter = _ref3.filter,
      filter = _ref3$filter === void 0 ? _api.default.LINEAR : _ref3$filter;
}
