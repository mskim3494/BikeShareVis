...
function (_Texture) {
  ...
  function TextureCube(gl) {
    ...
    _this = _possibleConstructorReturn(this, (TextureCube.__proto__ || Object.getPrototypeOf(TextureCube)).call(this, gl, Object.assign({}, opts, {
      target: _glConstants.GL.TEXTURE_CUBE_MAP
    })));
  ...
  _createClass(TextureCube, [{
    ...
    value: function initialize() {
      ...
      var _opts$format = opts.format,
          format = _opts$format === void 0 ? _glConstants.GL.RGBA : _opts$format,
      ...
      var _opts$width = opts.width,
          ...
          type = _opts$type === void 0 ? _glConstants.GL.UNSIGNED_BYTE : _opts$type,
      ...
      var _deduceImageSize = this._deduceImageSize({
        data: opts[_glConstants.GL.TEXTURE_CUBE_MAP_POSITIVE_X],
        width: width,
        height: height
      });
    ...
    value: function setCubeMapImageData(_ref2) {
      var width = _ref2.width,
          ...
          format = _ref2$format === void 0 ? _glConstants.GL.RGBA : _ref2$format,
          _ref2$type = _ref2.type,
          type = _ref2$type === void 0 ? _glConstants.GL.UNSIGNED_BYTE : _ref2$type,
