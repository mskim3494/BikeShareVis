...
var _attributeUtils = require("./helpers/attribute-utils");
  ...
  _createClass(Program, [{
    ...
    value: function draw(_ref3) {
      ...
      var _ref3$drawMode = _ref3.drawMode,
          drawMode = _ref3$drawMode === void 0 ? _api.default.TRIANGLES : _ref3$drawMode,
          ...
          indexType = _ref3$indexType === void 0 ? _api.default.UNSIGNED_SHORT : _ref3$indexType,
    ...
    value: function unsetBuffers() {
      ...
      this.gl.bindBuffer(_api.default.ELEMENT_ARRAY_BUFFER, null);
      return this;
    }
    /**
    ...
    value: function getAttributeCount() {
      return this._getParameter(_api.default.ACTIVE_ATTRIBUTES);
    }
    /**
    ...
    value: function getUniformCount() {
      return this._getParameter(_api.default.ACTIVE_UNIFORMS);
    }
    /*
    ...
    value: function _sortBuffersByLocation(buffers) {
      ...
      for (var bufferName in buffers) {
        ...
        if (location === undefined) {
          if (buffer.target === _api.default.ELEMENT_ARRAY_BUFFER && elements) {
            throw new Error("".concat(this._print(bufferName), " duplicate GL.ELEMENT_ARRAY_BUFFER"));
          } else if (buffer.target === _api.default.ELEMENT_ARRAY_BUFFER) {
            elements = bufferName;
          ...
          if (buffer.target === _api.default.ELEMENT_ARRAY_BUFFER) {
    ...
    value: function _getOptionsFromHandle(handle) {
      ...
      try {
        for (var _iterator = shaderHandles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var type = this.gl.getShaderParameter(this.handle, _api.default.SHADER_TYPE);

          switch (type) {
            case _api.default.VERTEX_SHADER:
              opts.vs = new _shader.VertexShader({
                handle: shaderHandle
              });
              break;

            case _api.default.FRAGMENT_SHADER:
