...
function () {
  ...
  _createClass(Resource, [{
    ...
    value: function getParameter(pname) {
      ...
      if (parameter) {
        var isWebgl2 = (0, _context2.isWebGL2)(this.gl); // Check if we can query for this parameter
    ...
    value: function setParameter(pname, value) {
      ...
      if (parameter) {
        var isWebgl2 = (0, _context2.isWebGL2)(this.gl); // Check if this parameter is available on this platform
