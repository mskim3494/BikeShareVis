...
function (_Resource) {
  ...
  _createClass(VertexArray, [{
    ...
    value: function setBuffer() {
      ...
      (0, _assert.default)(target, 'setBuffer needs target');
      (0, _assert.default)(layout, 'setBuffer called on uninitialized buffer');
      ...
      this.bind(function () {
        ...
        if (!layout.integer) {
          ...
          (0, _assert.default)((0, _context.isWebGL2)(gl));
    ...
    value: function setElements(elements) {
      (0, _assert.default)(!elements || elements.target === GL_ELEMENT_ARRAY_BUFFER, ERR_ELEMENTS);
    ...
    value: function _getLocations(buffers) {
      ...
      for (var bufferName in buffers) {
        ...
        if (buffer && buffer.target === GL_ELEMENT_ARRAY_BUFFER) {
          (0, _assert.default)(!elements, 'Duplicate GL.ELEMENT_ARRAY_BUFFER'); // assert(location === undefined, 'GL.ELEMENT_ARRAY_BUFFER assigned to location');
        ...
        (0, _assert.default)(Number.isFinite(location));
        (0, _assert.default)(!locations[location], "Duplicate attribute for binding point ".concat(location));
    ...
    value: function _sortBuffersByLocation(buffers) {
      ...
      for (var bufferName in buffers) {
        ...
        (0, _assert.default)(locations[location] === null, "Duplicate attribute for binding point ".concat(location));
    ...
    value: function _getData() {
      ...
      return new Array(this.MAX_ATTRIBUTES).fill(0).map(function (_, location) {
        ...
        PARAMETERS.forEach(function (parameter) {
          result[(0, _glConstants.glKey)(parameter)] = _this6.getParameter(parameter, {
            location: location
          });
        });
        return result;
