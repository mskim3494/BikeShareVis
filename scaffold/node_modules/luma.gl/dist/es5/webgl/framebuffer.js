...
var _formatUtils = require("./helpers/format-utils");
  ...
  _createClass(Framebuffer, [{
    ...
    value: function readPixels(_ref7) {
      var _ref7$x = _ref7.x,
          ...
          format = _ref7$format === void 0 ? _api.default.RGBA : _ref7$format,
          type = _ref7.type,
      ...
      if (attachment === _api.default.COLOR_ATTACHMENT0 && this.handle === null) {
        attachment = _api.default.FRONT;
    ...
    value: function readPixelsToBuffer(_ref8) {
      var _ref8$x = _ref8.x,
          ...
          format = _ref8$format === void 0 ? _api.default.RGBA : _ref8$format,
          type = _ref8.type,
      ...
      (0, _assert.default)((0, _context.isWebGL2)(gl)); // deduce type if not available.

      type = type || (buffer ? buffer.type : _api.default.UNSIGNED_BYTE);
      ...
      buffer.bind({
        target: _api.default.PIXEL_PACK_BUFFER
      });
    ...
    value: function copyToDataUrl() {
      ...
      while (height > maxHeight) {
        var _scalePixels = (0, _utils.scalePixels)({
          data: data,
          width: width,
          height: height
        });
    ...
    value: function blit(_ref12) {
      var srcFramebuffer = _ref12.srcFramebuffer,
          ...
          filter = _ref12$filter === void 0 ? _api.default.NEAREST : _ref12$filter;
      var gl = this.gl;
    ...
    value: function _createDefaultAttachments(_ref18) {
      ...
      if (color) {
        ...
        defaultAttachments[GL_COLOR_ATTACHMENT0] = new _texture2d.default(this.gl, {
          ...
          format: _api.default.RGBA,
          type: _api.default.UNSIGNED_BYTE,
          width: width,
          height: height,
          ...
          parameters: (_parameters = {}, _defineProperty(_parameters, _api.default.TEXTURE_MIN_FILTER, _api.default.NEAREST), _defineProperty(_parameters, _api.default.TEXTURE_MAG_FILTER, _api.default.NEAREST), _defineProperty(_parameters, _api.default.TEXTURE_WRAP_S, _api.default.CLAMP_TO_EDGE), _defineProperty(_parameters, _api.default.TEXTURE_WRAP_T, _api.default.CLAMP_TO_EDGE), _parameters)
        });
      ...
      if (depth) {
        ...
        defaultAttachments[GL_DEPTH_ATTACHMENT] = new _renderbuffer.default(this.gl, {
          format: _api.default.DEPTH_COMPONENT16,
          width: width,
          height: height
        });
    ...
    value: function _setReadBuffer(gl, readBuffer) {
      if ((0, _context.isWebGL2)(gl)) {
        ...
        (0, _assert.default)(readBuffer === GL_COLOR_ATTACHMENT0 || readBuffer === _api.default.BACK, ERR_MULTIPLE_RENDERTARGETS);
      }
    ...
    value: function _setDrawBuffers(gl, drawBuffers) {
      if ((0, _context.isWebGL2)(gl)) {
        ...
        if (ext) {
          ...
          (0, _assert.default)(drawBuffers.length === 1 && (drawBuffers[0] === GL_COLOR_ATTACHMENT0 || drawBuffers[0] === _api.default.BACK), ERR_MULTIPLE_RENDERTARGETS);
        }
      }
    ...
    value: function _getAttachmentParameterFallback(pname) {
      ...
      switch (pname) {
        case _api.default.FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER:
          // GLint
          return !caps.webgl2 ? 0 : null;

        case _api.default.FRAMEBUFFER_ATTACHMENT_RED_SIZE: // GLint

        case _api.default.FRAMEBUFFER_ATTACHMENT_GREEN_SIZE: // GLint

        case _api.default.FRAMEBUFFER_ATTACHMENT_BLUE_SIZE: // GLint

        case _api.default.FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE: // GLint

        case _api.default.FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE: // GLint

        case _api.default.FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE:
          // GLint
          return !caps.webgl2 ? 8 : null;

        case _api.default.FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE:
          // GLenum
          return !caps.webgl2 ? _api.default.UNSIGNED_INT : null;

        case _api.default.FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING:
          return !caps.webgl2 && !caps.EXT_sRGB ? _api.default.LINEAR : null;
