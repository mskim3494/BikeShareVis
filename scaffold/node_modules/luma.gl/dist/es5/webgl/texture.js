...
var _glConstants = _interopRequireWildcard(require("./gl-constants"));
...
var NPOT_MIN_FILTERS = [_glConstants.default.LINEAR, _glConstants.default.NEAREST]; // const S3TC = 'WEBGL_compressed_texture_s3tc';
...
var TEXTURE_FORMATS = (_TEXTURE_FORMATS = {}, _defineProperty(_TEXTURE_FORMATS, _glConstants.default.RGB, {
  dataFormat: _glConstants.default.RGB,
  types: [_glConstants.default.UNSIGNED_BYTE, _glConstants.default.UNSIGNED_SHORT_5_6_5]
}), _defineProperty(_TEXTURE_FORMATS, _glConstants.default.RGBA, {
  dataFormat: _glConstants.default.RGBA,
  types: [_glConstants.default.UNSIGNED_BYTE, _glConstants.default.UNSIGNED_SHORT_4_4_4_4, _glConstants.default.UNSIGNED_SHORT_5_5_5_1]
}), _defineProperty(_TEXTURE_FORMATS, _glConstants.default.ALPHA, {
  dataFormat: _glConstants.default.ALPHA,
  types: [_glConstants.default.UNSIGNED_BYTE]
}), _defineProperty(_TEXTURE_FORMATS, _glConstants.default.LUMINANCE, {
  dataFormat: _glConstants.default.LUMINANCE,
  types: [_glConstants.default.UNSIGNED_BYTE]
}), _defineProperty(_TEXTURE_FORMATS, _glConstants.default.LUMINANCE_ALPHA, {
  dataFormat: _glConstants.default.LUMINANCE_ALPHA,
  types: [_glConstants.default.UNSIGNED_BYTE] // [GL.DEPTH_COMPONENT]: {types: [GL.UNSIGNED_SHORT, GL.UNSIGNED_INT, GL.UNSIGNED_INT_24_8], gl1: DEPTH},
...
function isFormatSupported(gl, format) {
  (0, _assert.default)((0, _context.isWebGL)(gl), _context.ERR_WEBGL);
...
function isLinearFilteringSupported(gl, format) {
  ...
  switch (info && info.types[0]) {
    ...
    case _glConstants.default.FLOAT:
      return gl.getExtension('OES_texture_float_linear');
    // Not in WebGL2?

    case _glConstants.default.HALF_FLOAT:
  ...
  _createClass(Texture, [{
    ...
    value: function initialize() {
      ...
      var _opts$pixels = opts.pixels,
          ...
          format = _opts$format === void 0 ? _glConstants.default.RGBA : _opts$format,
          _opts$type = opts.type,
          type = _opts$type === void 0 ? _glConstants.default.UNSIGNED_BYTE : _opts$type,
      ...
      var DEFAULT_TEXTURE_SETTINGS = _defineProperty({}, _glConstants.default.UNPACK_FLIP_Y_WEBGL, unpackFlipY);
    ...
    value: function setImageData(_ref3) {
      ...
      var _ref3$target = _ref3.target,
          ...
          format = _ref3$format === void 0 ? _glConstants.default.RGBA : _ref3$format,
          type = _ref3.type,
      ...
      (0, _contextState.withParameters)(this.gl, parameters, function () {
        switch (dataType) {
          ...
          case 'buffer':
            ...
            (0, _assert.default)((0, _context.isWebGL2)(gl), _context.ERR_WEBGL2);
            gl.bindBuffer(_glConstants.default.PIXEL_UNPACK_BUFFER, data.handle || data);
    ...
    value: function setSubImageData(_ref4) {
      ...
      var _ref4$target = _ref4.target,
          ...
          format = _ref4$format === void 0 ? _glConstants.default.RGBA : _ref4$format,
          type = _ref4.type,
      ...
      (0, _contextState.withParameters)(this.gl, parameters, function () {
        ...
        if (compressed) {
          ...
          (0, _assert.default)((0, _context.isWebGL2)(_this4.gl), _context.ERR_WEBGL2); // This texImage2D signature uses currently bound GL_PIXEL_UNPACK_BUFFER

          _this4.gl.bindBuffer(_glConstants.default.PIXEL_UNPACK_BUFFER, data);

          _this4.gl.texSubImage2D(target, level, format, width, height, border, format, type, offset);

          _this4.gl.bindBuffer(_glConstants.default.GL_PIXEL_UNPACK_BUFFER, null);
        } else {
    ...
    value: function copyFramebuffer(_ref5) {
      var _ref5$target = _ref5.target,
          ...
          internalFormat = _ref5$internalFormat === void 0 ? _glConstants.default.RGBA : _ref5$internalFormat,
    ...
    value: function getActiveUnit() {
      return this.gl.getParameter(_glConstants.default.ACTIVE_TEXTURE) - _glConstants.default.TEXTURE0;
    } // target cannot be modified by bind:
    // textures are special because when you first bind them to a target,
    // they get special information. When you first bind a texture as a
    // GL_TEXTURE_2D, you are actually setting special state in the texture.
    ...
    value: function bind() {
      ...
      this.gl.activeTexture(_glConstants.default.TEXTURE0 + textureUnit);
      this.gl.bindTexture(this.target, this.handle);
      return textureUnit;
    }
  }, {
    ...
    value: function unbind() {
      ...
      this.gl.activeTexture(_glConstants.default.TEXTURE0 + this.textureUnit);
      this.gl.bindTexture(this.target, null);
    ...
    value: function setImage3D(_ref7) {
      var _ref7$level = _ref7.level,
          ...
          internalformat = _ref7$internalformat === void 0 ? _glConstants.default.RGBA : _ref7$internalformat,
          width = _ref7.width,
          height = _ref7.height,
          ...
          type = _ref7$type === void 0 ? _glConstants.default.UNSIGNED_BYTE : _ref7$type,
      ...
      if (_instanceof(pixels, _buffer.default)) {
        this.gl.bindBuffer(_glConstants.default.PIXEL_UNPACK_BUFFER, pixels.handle);
    ...
    */
    ...
    value: function _getParameter(pname) {
      switch (pname) {
        case _glConstants.default.TEXTURE_WIDTH:
          return this.width;

        case _glConstants.default.TEXTURE_HEIGHT:
          return this.height;
    ...
    value: function _setParameter(pname, param) {
      ...
      switch (pname) {
        case _glConstants.default.TEXTURE_MIN_LOD:
        case _glConstants.default.TEXTURE_MAX_LOD:
    ...
    value: function _getNPOTParam(pname, param) {
      if (this._isNPOT()) {
        switch (pname) {
          case _glConstants.default.TEXTURE_MIN_FILTER:
            if (NPOT_MIN_FILTERS.indexOf(param) === -1) {
              _utils.log.warn("texture: ".concat(this, " is Non-Power-Of-Two, forcing TEXTURE_MIN_FILTER to LINEAR"))();

              param = _glConstants.default.LINEAR;
            }

            break;

          case _glConstants.default.TEXTURE_WRAP_S:
          case _glConstants.default.TEXTURE_WRAP_T:
            if (param !== _glConstants.default.CLAMP_TO_EDGE) {
              _utils.log.warn("texture: ".concat(this, " is Non-Power-Of-Two, ").concat((0, _glConstants.glKey)(pname), " to CLAMP_TO_EDGE"))();

              param = _glConstants.default.CLAMP_TO_EDGE;
            }
