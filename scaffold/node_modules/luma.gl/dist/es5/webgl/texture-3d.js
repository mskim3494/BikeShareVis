...
function (_Texture) {
  ...
  function Texture3D(gl) {
    ...
    _this = _possibleConstructorReturn(this, (Texture3D.__proto__ || Object.getPrototypeOf(Texture3D)).call(this, gl, Object.assign({}, opts, {
      target: opts.target || _api.default.TEXTURE_3D
    })));
    _this.width = null;
    _this.height = null;
    _this.depth = null;
  ...
  _createClass(Texture3D, [{
    ...
    value: function setImage3D(_ref) {
      var _ref$level = _ref.level,
          ...
          internalformat = _ref$internalformat === void 0 ? _api.default.RGBA : _ref$internalformat,
          width = _ref.width,
          height = _ref.height,
      ...
      if (_instanceof(pixels, _buffer.default)) {
        this.gl.bindBuffer(_api.default.PIXEL_UNPACK_BUFFER, pixels.handle);
