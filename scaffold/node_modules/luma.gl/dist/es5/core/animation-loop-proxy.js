...
var _animationLoop = _interopRequireWildcard(require("./animation-loop"));
...
function () {
  ...
  _createClass(AnimationLoopProxy, [{
    ...
    value: function start() {
      ...
      if (!this._animationFrameId) {
        ...
        this._startPromise = (0, _webglUtils.getPageLoadPromise)().then(function () {
          ...
          if (!_this._stopped) {
            _this._animationFrameId = (0, _animationLoop.requestAnimationFrame)(_this._updateFrame);
          }
        });
      }
    ...
    value: function stop() {
      if (this._animationFrameId) {
        (0, _animationLoop.cancelAnimationFrame)(this._animationFrameId);
        this._animationFrameId = null;
        this._stopped = true;
    ...
    value: function _updateFrame() {
      ...
      this._animationFrameId = (0, _animationLoop.requestAnimationFrame)(this._updateFrame);
    }
  }, {
    key: "_createAndTransferCanvas",
    value: function _createAndTransferCanvas(opts) {
      // Create a canvas on the main thread
      var screenCanvas = (0, _webglUtils.createCanvas)(opts); // Create an offscreen canvas controlling the main canvas
