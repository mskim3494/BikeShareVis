...
function (_Object3D) {
  ...
  function Model(gl) {
    ...
    (0, _assert.default)((0, _webgl.isWebGL)(gl));
    _this.gl = gl;
  ...
  _createClass(Model, [{
    ...
    value: function init() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
          ...
          bufferMode = _ref$bufferMode === void 0 ? _webgl.GL.SEPARATE_ATTRIBS : _ref$bufferMode,
    ...
    value: function _createBuffersFromAttributeDescriptors(attributes) {
      ...
      for (var attributeName in attributes) {
        ...
        if (_instanceof(attribute, _webgl.Buffer)) {
