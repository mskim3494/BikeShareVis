...
function requestAnimationFrame(callback) {
  return _globals.window.requestAnimationFrame ? _globals.window.requestAnimationFrame(callback) : setTimeout(callback, 1000 / 60);
}

function cancelAnimationFrame(timerId) {
  return _globals.window.requestAnimationFrame ? _globals.window.cancelAnimationFrame(timerId) : clearTimeout(timerId);
}
  ...
  _createClass(AnimationLoop, [{
    ...
    value: function _resizeCanvasDrawingBuffer() {
      if (this.autoResizeDrawingBuffer) {
        (0, _webglUtils.resizeDrawingBuffer)(this.gl.canvas, {
          useDevicePixels: this.useDevicePixels
        });
      }
    } // TBD - deprecated?
