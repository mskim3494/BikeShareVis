...
var _glConstants = _interopRequireDefault(require("../../webgl/gl-constants"));
  ...
  _createClass(Transform, [{
    ...
    value: function initialize(_ref) {
      var _ref$sourceBuffers = _ref.sourceBuffers,
          ...
          drawMode = _ref$drawMode === void 0 ? _glConstants.default.POINTS : _ref$drawMode,
    ...
    value: function update(_ref2) {
      ...
      for (var bufferName in sourceBuffers) {
        (0, _assert.default)(_instanceof(sourceBuffers[bufferName], _buffer.default));
      }

      for (var _bufferName in destinationBuffers) {
        (0, _assert.default)(_instanceof(destinationBuffers[_bufferName], _buffer.default));
      }
    ...
    value: function run() {
      ...
      model.draw({
        ...
        uniforms: uniforms,
        parameters: _defineProperty({}, _glConstants.default.RASTERIZER_DISCARD, true)
      });
    ...
    value: function _bindBuffers(_ref4) {
      ...
      for (var _bufferName2 in destinationBuffers) {
        (0, _assert.default)(_instanceof(destinationBuffers[_bufferName2], _buffer.default));
      }
