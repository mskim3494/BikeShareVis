...
const GL_STENCIL_ATTACHMENT = 0x8D20; // const GL_DEPTH_STENCIL_ATTACHMENT = 0x821A;
...
export default class Framebuffer extends Resource {
  ...
  attach(attachments, {
    ...
    const prevHandle = this.gl.bindFramebuffer(GL_FRAMEBUFFER, this.handle); // Walk the attachments
  ...
  getAttachmentParameters(attachment = GL_COLOR_ATTACHMENT0, parameters = this.constructor.ATTACHMENT_PARAMETERS || {}) {
    const values = {};
